...
var (
	...
	// Avaliability
	ERR_AVALIABILITY_DURATION_TOO_SHORT    = err("ERR_AVALIABILITY_DURATION_TOO_SHORT", 0)
	ERR_AVALIABILITY_START_BEFORE_EVENT    = err("ERR_AVALIABILITY_START_BEFORE_EVENT", 0)
	ERR_AVALIABILITY_START_AFTER_EVENT     = err("ERR_AVALIABILITY_START_AFTER_EVENT", 0)
	ERR_AVALIABILITY_INVALID_TIME_INTERVAL = err("ERR_AVALIABILITY_INVALID_TIME_INTERVAL", 0)
)
...
var CUSTOM_ERRORS = []CustomError{
	...
	// Avaliability
	ERR_AVALIABILITY_DURATION_TOO_SHORT,
	ERR_AVALIABILITY_START_BEFORE_EVENT,
	ERR_AVALIABILITY_START_AFTER_EVENT,
	ERR_AVALIABILITY_INVALID_TIME_INTERVAL,
}
