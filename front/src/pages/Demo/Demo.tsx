...
export const Demo = () => (
  <div className={classes.container}>
    ...
    <div className={classes.paragraphContainer}>
      ...
      <div className={classes.infoSection}>
        <p className={classes.paragraphStyle}>
          The goal of this <span className={classes.boldText}>starter kit</span> is to enable you to quickly start a new
          project with all the necessary tools.
        </p>
        <p className={classes.paragraphStyle}>
    ...
    <div className={classes.paragraphContainer}>
      ...
      <div className={classes.infoSection}>
        <p className={classes.paragraphStyle}>
          ...
          state in React applications. (for more details check the <span className={classes.highlight}>README.md</span>{' '}
          file under the <span className={classes.boldText}>hooks</span> folder)
        </p>
      ...
      <div className={classes.infoSection}>
        <p className={classes.paragraphStyle}>
          <span className={classes.boldText}>React Hook Form: </span>A library for managing forms with React hooks. (for
          more details check the <span className={classes.highlight}>README.md</span> file under the{' '}
      ...
      <div className={classes.infoSection}>
        <span className={classes.centredText}>
          <p className={classes.paragraphStyle}>
            ...
            additional information. This documentation will guide you through setting up the environment, understanding
            the project structure, and using the available components and features. For more details, check the{' '}
            <span className={classes.highlight}>README.md</span> file in{' '}
