...
describe('TextareaField', () => {
  it('renders without crashing', () => {
    render(
      <FormWrapper>
        <TextareaField name="description" label="Description" placeholder="Enter your description" />
      </FormWrapper>,
    );
    ...
    const WrapperWithError = () => {
      ...
      return (
        <FormProvider {...methods}>
          ...
          <button onClick={() => setError('description', { message: 'This field is required' })}>Trigger error</button>
        </FormProvider>
      );
    };
