...
The Input component is designed to:
...
```tsx
<Input input={TextInputAtom} label="Username" error="This field is required" required className="custom-class" />
```
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>No</td>
      <td>Default CSS class for the wrapper (defaults to "ds-input")</td>
    </tr>
    <tr>
      <td>
        <code>...props</code>
...
```tsx
<Input input={TextInputAtom} label="Email Address" placeholder="Enter your email" />
```

### Input with Error

```tsx
<Input input={TextInputAtom} label="Email Address" error="Invalid email format" placeholder="Enter your email" />
```

### Required Input

```tsx
<Input input={TextInputAtom} label="Username" required placeholder="Choose a username" />
```

### Input with Custom Styling

```tsx
<Input input={TextInputAtom} label="Custom Field" className="my-custom-class" placeholder="Enter value" />
```
