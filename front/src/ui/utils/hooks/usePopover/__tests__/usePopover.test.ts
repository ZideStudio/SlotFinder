...
describe("usePopover", () => {
  describe("triggerProps", () => {
    it("should set popoverTarget matching popoverProps.id", () => {
      ...
      expect(result.current.triggerProps.popoverTarget).toBe(
    ...
    it("should set the anchor name CSS custom property in style", () => {
      const { result } = renderHook(() => usePopover());
      const anchorName = (
        result.current.triggerProps.style as Record<string, string>
      )["--popover-anchor-name"];
  ...
  describe("popoverProps", () => {
    ...
    it("should share the same anchor name CSS custom property as triggerProps", () => {
      ...
      const popoverAnchor = (
        result.current.popoverProps.style as Record<string, string>
      )["--popover-anchor-name"];
  ...
  describe("anchor name uniqueness", () => {
    it("should generate a unique anchor name for each hook instance", () => {
      ...
      const anchor1 = (
        result1.current.triggerProps.style as Record<string, string>
      )["--popover-anchor-name"];
      const anchor2 = (
        result2.current.triggerProps.style as Record<string, string>
      )["--popover-anchor-name"];
